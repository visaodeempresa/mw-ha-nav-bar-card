...
REPO = "visaodeempresa/mw-ha-nav-bar-card"          # dono/repositório no GitHub
NOME = "mw-ha-nav-bar-card"                    # a pasta em /config/www/community
CARD = "mw-nav-bar-card"                    # o arquivo .js, sem extensão
